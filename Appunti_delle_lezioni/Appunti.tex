...
\subsection{Tubo catodico 2}
Bisogna stare molto attenti a dare la tensione giusta alla lampadina del tubo catodico, in quanto nel caso si bruci bisogna sostituire tutto il tubo catodico. Riguardo alla tensione di $\sim 1500 V$ è impostata sia per non avere fenomeni
di scarica, ma anche perchè il metallo può essere soggetto ad fenomeni di vaporizzazione e creazione di raggi X. La creazione dei raggi X è dovuto all'eccessiva energia degli elettroni che andando a collidere con il metallo vanno ad eccitare gli elettroni dei gusci profondi,
questi quando ritornando alla posizione di equilibrio emettono radiazioni nella banda dei raggi X.\\
Per collimare gli elettroni si usa un elettrodo cilindrico, con una tensione di collimazione negativa, questo crea il minimo di potenziale del campo sul suo asse di simmetria, che è allineato con quello del cilindro.
