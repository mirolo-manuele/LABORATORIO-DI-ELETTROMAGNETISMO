...
df = pd.read_excel("/mnt/c/Users/manue/Documents/UNIVERSITA'/II ANNO/LABORATORIO-DI-ELETTROMAGNETISMO/relazioni/esperienza_2/codici/Esperienza_2.xlsx", sheet_name="Temp_2") #legge il file excel
...
c.Update()
c.Draw()
c.SaveAs("coefficiente_eta2.png") 
