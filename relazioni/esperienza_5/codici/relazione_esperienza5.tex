...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{presa_dati_manaule}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{fit_presa_dati_manaule}
...
È possibile osservare sia dal primo ma soprattutto dal secondo grafico che nella fase di carica il si riscontra l'effettivo andamento lineare mentre dagli istanti di tempo successivi a $ 6 \dot 10^-6$ risulta esserci una deviazione dalla linearità questo probabilmente è  causato dal raggiungimento della tensione di regime, dove il tasso di variazione di quest'ultima si avvicina a zero:
