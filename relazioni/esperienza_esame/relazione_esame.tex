...
Nel caso considerato si può osservare che:
\begin{itemize}
...
Questo è dovuto alla differenza di tensione media che si può osservare nei grafici. La differenza di tensione media può essere attribuita ad un diverso comportamento del condensatore o ad un'errata presa dati.
