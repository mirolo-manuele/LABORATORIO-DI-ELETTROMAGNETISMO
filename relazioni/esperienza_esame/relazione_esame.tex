...
questo per verificare che effettivamente avessero caratteristiche simili tra loro,
come da dichiarazione nominale.\\
...
\end{circuitikz}
    \caption{Circuito con diodo e condensatore in parallelo.}
    \label{fig:etichetta}
  \end{figure}
\end{center}
