...
>>>>>>> c66b2c541feb3836562b4058aa31552fa2a88bb7
    \label{fig:curva_ponte_confronto}
\end{figure}
In questo grafico si vede il confronto tra segnale in ingresso, segnale raddrizzato 
e segnale rettificato. Si nota che l'aggiunta di ogni elemento circuitale diminuisce
...
\begin{figure}[H]
    \centering    \includegraphics[width=0.52\textwidth]{codici/ponte/ponte_3.pdf}
...
\end{figure}
=======
In questo grafico si vede l'andamento della corrente raddrizzata dalla
configurazione a ponte di Graetz, per due diversi valori di R e C (con R fissato e C variabile).
L'andamento della tensione riportato in rosa dimostra come con un RC sufficientemente
...
una differenza di potenziale maggiore tra le due armature. Ciò, però, implica anche
un processo di scarica più rapido (rispetto a una scelta di RC maggiore), ovvero
