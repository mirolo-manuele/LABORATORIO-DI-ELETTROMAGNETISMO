...
Nel nostro caso:
\[ \Delta V_{\max}= 1.80 V\]
durante il picco si ha $I \simeq 18 mA$, dunque per \ref{fig:curva_diodi} su ogni diodo abbiamo una caduta di potenziale di circa $0.7 V$, 
il che ci porta a pensare che nel resto del circuito si va a perdere $0.4 V$.
