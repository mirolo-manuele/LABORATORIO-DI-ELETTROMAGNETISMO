...
\begin{figure}[H]
    \centering    \includegraphics[width=0.4\textwidth]{curva_diodi.pdf}
...
quattro diodi, in \ref{fig:curva_diodi} sono state riportate tutte insieme per rendere più semplice il confronto. Si osserva in modo 
