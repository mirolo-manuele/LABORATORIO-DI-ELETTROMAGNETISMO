...
\justifying
	...
	\author{ \hspace{0.7cm} Ferrari Carola \hspace{0.7cm} Mirolo Manuele \hspace{0.7cm} Stroili Emanuele}
...
\vspace{3cm}
	\begin{abstract}
		\centering
		\large
    Le due esperienze, svolte in due settimane differenti, consistono (..), nello studio di un circuito RLC in serie nel suo dominio dei tempi
    e infine nell'analisi dell'effetto di risonanza al suo interno
